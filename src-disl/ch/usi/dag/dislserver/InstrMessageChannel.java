...
final class InstrMessageChannel implements Closeable {
    ...
    public InstrMessageChannel(final SocketChannel socket) {
        __socket = socket;
    }

    //

    public InstrMessage recvMessage () throws IOException {
        //
        // request protocol:
        //
        ...
        return new InstrMessage(flags, control, payload);
    }


    public void sendMessage (final InstrMessage message) throws IOException {
        //
        // response protocol:
        //
